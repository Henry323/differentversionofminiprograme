...
Page({
  ...
  finishEdit:function(){
    var that = this;
        if (this.data.Temail.length == 0 || this.data.Tmajor1.length == 0|| this.data.Tmajor2.length == 0|| this.data.Tname.length == 0) {
          wx.showToast({
    ...
                  })
              wx.navigateTo({
                 url: '../personalinfor/personalinfor?NameData='+that.data.Tname+'&Major1Data='+that.data.Tmajor1+'&Major2Data='+that.data.Tmajor2+'&EmailData='+that.data.Temail
          
               })
